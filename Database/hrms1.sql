...
(
    id integer NOT NULL,
    first_name character varying(33) NOT NULL,
    last_name character varying(33) NOT NULL,
...
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 1247483647 CACHE 1 ),
    email character varying(300) NOT NULL,
    password character varying(23) NOT NULL,
    PRIMARY KEY (id)
);
...
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 124748364 CACHE 1 ),
