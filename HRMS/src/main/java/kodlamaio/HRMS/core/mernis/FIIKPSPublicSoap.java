...
public class FIIKPSPublicSoap
{
    ...
    {
        FIIExtendedSoapSerializationEnvelope envelope= new FIIExtendedSoapSerializationEnvelope(FIIExtendedSoapSerializationEnvelope.VER11);
